...
export default function Chatbox({ session }: AITutorProps) {
    
    if(session){
        return (
            <div className="flex justify-center items-center w-full h-full rounded-lg bg-[#20232D] p-4">
                Coming Soon..
            </div>
        ...
        return (
            <div className="flex justify-center items-center w-full h-full rounded-lg bg-[#20232D] p-4">
                <Button label={'Log in'} href='/auth/login' classname="bg-[#303346]"/> 
            </div>
        )
    }
}
